export function d5aIdentificador() {
 return (/* html */
  `<h1>A. <dfn>Identificador</dfn></h1>
   <div class="lectura">
    ...
    <ul>
     ...
     <li>
      <p>
       Aunque JavaScript permite utilizar caracteres acentuados en los
       identificadores, algunas herramientas de desarrollo no manejan bien estos
       caracteres.
      </p>
     </li>
    </ul>
