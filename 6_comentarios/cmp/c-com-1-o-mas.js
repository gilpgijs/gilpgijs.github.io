 ...
 connectedCallback() {
  ...
  this.innerHTML = /* html */
   ...
   <div class="horizontal">
    <div>
     <h2>Salida</h2>
     <iframe src="/6_comentarios/src/2_comentarios_una_o_mas.html"></iframe>
     <p class="noPrint">
      <a target="_blank" rel="noopener" href="/6_comentarios/src/2_comentarios_una_o_mas.html">Ábrelo en otra
       pestaña.</a>
     </p>
     <p class="noPrint">
