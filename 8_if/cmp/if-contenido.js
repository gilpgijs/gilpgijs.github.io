 ...
 connectedCallback() {
  ...
  this.innerHTML = /* html */
   `<ol type="A">
     ...
     <li>
      <p>
       <a href="/8_if/e_if_true.html">Prueba de escritorio cuando la
     ...
     <li>
      <p>
       <a href="/8_if/f_if_false.html">Prueba de escritorio cuando la
        condición de <strong>if</strong> evalúa a
     ...
     <li>
      <details>
       <summary>
        <h4>
         <a href="/8_if/g_if_programa/index.html">Programa con
          <strong>if</strong></a>
        </h4>
       </summary>
