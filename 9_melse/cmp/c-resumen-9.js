  ...
  this.innerHTML = /* html */
   ...
   <div class="lectura">
    <ul>
     <li>
      <p>
       La <dfn>condicional múltiple con else</dfn> es una lista en la que:
      </p>
      <ol>
       <li>
        <p>
       ...
       <li>
        <p>
         ...
         <code class="language-javascript">else</code>, seguida de un
     ...
     <li>
      <p>
       ...
       empezando por la primera condición. Se ejecuta el bloque de instrucciones
       que corresponda a la primera condición que evalue a
       <code class="language-javascript">true</code>
       y luego se termina la estructura, continuando con las instrucciones que
       aparezcan después de la lista.
      </p>
     </li>
     <li>
      <p>
       ...
       <code class="language-javascript">else</code>
       final, continuando con las instrucciones que aparezcan después de la
       lista.
      </p>
     </li>
    </ul>
...
customElements.define("c-resumen-9", CResumen);