...
export class CtrlDiapositiva extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = /* html */
      `<a class=anterior><span class="material-icons">skip_previous</span></a>
      <button class=toc><span class="material-icons">toc</span></button>
      <a class=siguiente><span class="material-icons">skip_next</span></a>
      <div class=cierra></div><nav><header><button class=cierra><span class="material-icons">close</span></button></header>${this.lista}</nav>`;
