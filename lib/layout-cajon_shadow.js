...
export const SHADOW_HTML = /* html */
  ...
  </style><div id=cortina></div><div id=cierra class=cierra></div><nav id=nav><header><button class=cierra title="Cierra">&#x2715;</button></header><slot id=slotNav name=nav></slot></nav><div id=separador></div><div id=principal><div id=toolbar><button id=abre type=button title=Menú>&#x2630;</button><slot name=toolbar></slot></div><slot id=contenido></slot></div>`;