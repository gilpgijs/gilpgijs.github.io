...
export const SHADOW_HTML = /* html */
  ...
  </style><link href="/css/material-icons.css" rel=stylesheet><div id=cortina></div><div id=cierra class=cierra></div><nav id=nav><header><button class=cierra><span class="material-icons">close</span></button></header><slot id=slotNav name=nav></slot></nav><div id=separador></div><div id=principal><div id=toolbar><button id=abre type=button><span class="material-icons">menu</span></button><slot name=toolbar></slot></div><slot id=contenido></slot></div>`;